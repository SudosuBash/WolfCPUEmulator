...
#define MMU_CONTROLLER_NOW_BUSDEVICE_CMD 0x1
#define MMU_CONTROLLER_NOW_BUSDEVICEID_REGA 0x2
#define MMU_CONTROLLER_NOW_BUSDEVICE_NEED_SPACE_REGA 0x3
#define MMU_CONTROLLER_NOW_BUSDEVICE_VAL_REGA 0x4
